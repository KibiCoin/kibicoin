...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Kibicoin Core kibicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kibicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kibicoin transaction") + "\n" +
              "  kibicoin-tx [options] -create [commands]   " + _("Create hex-encoded kibicoin transaction") + "\n" +
              "\n";
